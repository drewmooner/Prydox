...
const prydoxMarket = require(path.join(process.cwd(), "markets", "prydox"));
...
const loadPoolConfig = (configName) => {
    switch (configName) {
        ...
        case ConfigNames.Prydox:
            return prydoxMarket.default || prydoxMarket.PrydoxMarket;
        default:
